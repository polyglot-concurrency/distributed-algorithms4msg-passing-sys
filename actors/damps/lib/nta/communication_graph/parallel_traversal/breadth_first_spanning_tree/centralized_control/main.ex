...
defmodule NTA.CommunicationGraph.ParallelTraversal.BreadthFirstSpanningTree.CentralizedControl.Main do
    alias NTA.CommunicationGraph.ParallelTraversal.BreadthFirstSpanningTree.CentralizedControl.Process, as: MainProcess
    ...
    defmodule Manager do
        ...
        def handle_info(:print, state) do
            ...
            for {k, v} <- state.labels do
                IO.puts("Node: #{v}")
                IO.puts("Distance: #{MainProcess.get_distance(k)}")
